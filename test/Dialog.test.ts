...
describe('Dialog', () => {
  describe('decodeDialogId', () => {
    it('should decode IDs at the range edges correctly', () => {
      ...
      expect(Option.getOrThrow(Dialog.decodeDialogId(-1997852516352))).toEqual({ peer: 'channel', id: 997852516352 })
      expect(Option.getOrThrow(Dialog.decodeDialogId(-1000000000001))).toEqual({ peer: 'channel', id: 1 })
    ...
    it('should decode valid IDs correctly', () => {
      ...
      expect(Option.getOrThrow(Dialog.decodeDialogId(-1500000000000))).toEqual({ peer: 'channel', id: 500000000000 })
  ...
  describe('decodePeerId', () => {
    it('should decode IDs at the range edges correctly', () => {
      ...
      expect(Option.getOrThrow(Dialog.decodePeerId('channel', -1997852516352))).toBe(997852516352)
      expect(Option.getOrThrow(Dialog.decodePeerId('channel', -1000000000001))).toBe(1)
    ...
    it('should decode valid IDs correctly', () => {
      ...
      expect(Option.getOrThrow(Dialog.decodePeerId('channel', -1500000000000))).toBe(500000000000)
    ...
    it('should return None for mismatched peer type', () => {
      ...
      expect(Option.isNone(Dialog.decodePeerId('channel', -1))).toBe(true)
  ...
  describe('encodePeerId', () => {
    it('should encode IDs at range edges correctly', () => {
      ...
      expect(Option.getOrThrow(Dialog.encodePeerId('channel', 1))).toBe(-1000000000001)
      expect(Option.getOrThrow(Dialog.encodePeerId('channel', 997852516352))).toBe(-1997852516352)
    ...
    it('should return None for IDs outside valid range', () => {
      ...
      expect(Option.isNone(Dialog.encodePeerId('channel', 0))).toBe(true)
      expect(Option.isNone(Dialog.encodePeerId('channel', 997852516353))).toBe(true)
